...
var hotproperty;
        ...
        function dropClubs() {
            ...
            var clubs = [
                ['Botanic Gardens',1.3138397, 103.8159136, 1, '<b>Singapore Botanic Gardens</b><br><br>1 Cluny Rd, Singapore 259569<br>Tel: 6471 7138 &nbsp;&nbsp; <br>Web: <a href="https://www.sbg.org.sg/" target="_blank"  class="gmplink">www.sbg.org.sg/</a>'],
            ...
            setMarkers(clubs, 'assets/img/icons/icon_recreation.png');
            infowindow = new google.maps.InfoWindow({
                    content: "loading..."
                });

            // show listing in sidebar
            showList('Recreation & Entertainment', clubs);
        }
        ...
        function dropShopping() {
            ...
            var shopping_malls = [
                ...
                ['Delfi Orchard',1.307238,103.828526, 1, '<b>Delfi Orchard</b><br><br>402 Orchard Road<br>Tel: 6877 1818'],
               
                ['Shaw House',1.305616, 103.83163200000001, 1, '<b>Isetan @ Shaw House</b><br><br>350 Orchard Road, Singapore 238367<br>Tel: 65 6235 2077  <br>Web: <a href="http://www.shaw.sg/" target="_blank"  class="gmplink">www.shaw.sg/</a>'],
...
, 1, '<b>Ngee Ann City</b><br><br>391 Orchard Road Singapore 238873<br>Web: <a href="http://www.ngeeanncity.com.sg/" target="_blank"  class="gmplink">www.ngeeanncity.com.sg/</a>'],
                ...
                ['Scotts Square',1.3058803, 103.8307667, 1, '<b>Scotts Square</b><br><br>6 Scotts Rd, Singapore 228209<br>Tel:6636 3633 <br>Web: <a href="http://www.scottssquareretail.com/" target="_blank"  class="gmplink">www.scottssquareretail.com/</a>'],
                ...
                ['Dempsey Hill', 1.3033085, 103.80985190000001, 1, '<b>Dempsey Hill</b><br><br>Blk 8D, Dempsey Road, Singapore 249679<br>']
            ];
            ...
            // show listing in sidebar
            showList('Shopping & Dining', shopping_malls);
        }
        ...
        function dropHospitals() {
            ...
            var hospitals = [
                ['Gleneagles Hospital and Medical Centre', 1.30752, 103.82034999999996, 1, '<b>Gleneagles Hospital and Medical Centre</b><br><br>6A Napier Road Singapore 258500<br>Tel: 6473 7222 &nbsp;&nbsp; Fax: 6470 5616<br>Web: <a href="http://www.parkwayhealth.com/hospitals/gleneagles_hospital/" target="_blank"  class="gmplink">www.parkwayhealth.com/hospitals/gleneagles_hospital/</a>'],
        ...
        function dropAccess() {
            ...
            var access = [
                ['Orchard MRT Station', 1.3108046, 103.82679819999998, 1, '']
            ];

            setMarkers(hotels, 'assets/img/icons/icon_access.png');
            infowindow = new google.maps.InfoWindow({
                    content: "loading..."
                });

            // show listing in sidebar
            showList('Accessibility', access);
        }
        ...
        function setMarkers(markers, icon_image) {
            ...
            for (var i = 0; i < markers.length; i++) {
                ...
                if (sites[0] == 'Chong Pang Market & Food Centre') {
                    local_icon_image = 'assets/img/icons/icon_shopping.png';
                }
                var image = {
                  url: local_icon_image,
