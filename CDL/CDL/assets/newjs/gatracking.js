...
(function ($) {
    $(document).ready(function () {
        ...
        // Sticky-navigation
		 ...
		 //02052017
        $('.nav-sticky-menu').children().click(function () {
            pushGAEvent('Property Site Navigation Bar', 'click', $(this).find('a').text());
        })

        //02052017
        $('.hotline').children('.lightbox-generic').click(function () {
            pushGAEvent('Property Site Navigation Bar', 'click', $(this).text());
        })
        ...
        $('.prop-contact-body a').click(function () {
            if ($(this).hasClass('link')) {
                label = 'View_Map'
            }
            else {
